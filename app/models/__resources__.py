...
class Resources:
    ...
    original_display_pictures = [
        ...
        {'attribution': 'Gary Bendig', 'attribution_url': 'https://unsplash.com/@kris_ricepees',
         'filename': 'ogdp10.png',
         'unique_display_picture_id': 10},
        {'attribution': 'Christopher Carson', 'attribution_url': 'https://unsplash.com/@bhris1017',
         'filename': 'ogdp16.png', 'unique_display_picture_id': 16},
        {'attribution': 'Geranimo', 'attribution_url': 'https://unsplash.com/@geraninmo', 'filename': 'ogdp9.png',
         'unique_display_picture_id': 9},
        {'attribution': 'Cristina Anne Costello', 'attribution_url': 'https://unsplash.com/@lightupphotos',
         'filename': 'ogdp15.png', 'unique_display_picture_id': 15},
        ...
        {'attribution': 'Charles Deluvio', 'attribution_url': 'https://unsplash.com/@charlesdeluvio',
         'filename': 'ogdp18.png', 'unique_display_picture_id': 18},
        {'attribution': 'Matthew Henry', 'attribution_url': 'https://unsplash.com/@matthewhenry',
         'filename': 'ogdp7.png',
        ...
        {'attribution': 'Ricky Kharawala', 'attribution_url': 'https://unsplash.com/@sweetmangostudios',
         'filename': 'ogdp3.png', 'unique_display_picture_id': 3},
        {'attribution': 'Chris Curry', 'attribution_url': 'https://unsplash.com/@chriscurry92',
         'filename': 'ogdp17.png',
        ...
        {'attribution': 'Andriyko Podilnyk', 'attribution_url': 'https://unsplash.com/@andriyko',
         'filename': 'ogdp20.png',
        ...
        {'attribution': 'Richard Brutyo', 'attribution_url': 'https://unsplash.com/@richardbrutyo',
         'filename': 'ogdp4.png',
         'unique_display_picture_id': 4},
        {'attribution': 'Nathan Anderson', 'attribution_url': 'https://unsplash.com/@nathananderson',
         'filename': 'ogdp6.png', 'unique_display_picture_id': 6}
    ]
